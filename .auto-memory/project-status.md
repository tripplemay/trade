...
---
## 当前状态
- **B021-cloud-deploy-auth：`building`**；F001 OAuth + F002 SQLite/Alembic/Repository/workbench-bootstrap 双 feature 完成（commits 2a53c89 + b46d098，CI 全绿），共 6 features 完成 2。Generator 接 F003（systemd workbench-{backend,frontend}.service + nginx vhost trade.guangai.ai + deploy/rollback/healthcheck 脚本 + CERTBOT-SETUP.md）。预估剩余 1-2 周。
