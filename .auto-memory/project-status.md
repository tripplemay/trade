...
---
## 当前状态
- **B024-i18n-zh-cn：`building`**（Generator 接 F001）；6 features：F001 next-intl 基建 + middleware chain + LocaleSwitcher / F002 UI Pass A 9 read-mostly 页 / F003 UI Pass B 5 execution+login+中文按钮禁词 / F004 后端 API error i18n / F005 Markdown 双语 disclaimer / F006 codex L1+L2 双 locale 真 VM 验收。F001-F005 generator，F006 codex。预估 3-4 周。
