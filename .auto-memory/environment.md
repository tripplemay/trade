...
## 生产环境（2026-06-18 — 实测填实）

- 前端/控制台：`https://astock.guangai.ai`（nginx server_name 实测；workbench 前端）
- API：`https://astock.guangai.ai/api`
- 注：同 VM 还托管其它项目（kol.guangai.ai=KOLMatrix / aigc.guangai.ai=LLM gateway），本项目=**astock.guangai.ai**。
