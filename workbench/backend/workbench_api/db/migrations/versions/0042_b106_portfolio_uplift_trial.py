"""B106 F002 — auto-seed the Master 组合层 uplift A/B trial into trial_registry.

Same deploy-safe pattern as 0038/0039/0040 (alembic upgrade, never bootstrap —
B080 F005): a portfolio-layer A/B is a distinct CONFIG tried → DSR ``N``. Idempotent
by content id.

Revision ID: 0042_b106_portfolio_uplift_trial
Revises: 0041_curated_symbol_names_seed
...
revision: str = "0042_b106_portfolio_uplift_trial"
down_revision: str | Sequence[str] | None = "0041_curated_symbol_names_seed"
