...
def build_portfolio_output(
    ...
    risk = evaluate_result_risk(result, max_single_etf_weight)
...
def evaluate_result_risk(
    result: MonthlyBacktestResult, max_single_etf_weight: float = 0.35
) -> RiskCheckResult:
    return evaluate_risk(
        target_weights=result.signal.target_weights,
        equity_curve=(result.starting_capital, result.ending_value),
