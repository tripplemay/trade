...
**来源：** B021 F006 fix-round 1-7（commits `e5020ea` 起到 `4eb9c48` 止），signoff `docs/test-reports/B021-cloud-deploy-auth-signoff-2026-05-17.md`，runbook `docs/dev/B021-vm-setup-runbook.md` §B021 first-time VM bootstrap addendum。
